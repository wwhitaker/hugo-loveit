...
My specific environment requires an alterative to hard wired APs to satisfy coverage needs.  The U6 Mesh has a nice 4x4 spectrum 5GHz radios to help squeeze the most out of the wireless backhauls when necessary.  They are only Wifi-6 models with no 6GHz radios but that doesn't matter with my mix of everyday wireless clients.
